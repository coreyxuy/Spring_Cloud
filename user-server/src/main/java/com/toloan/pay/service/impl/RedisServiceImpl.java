...
import com.toloan.pay.config.JedisConfig;
import com.toloan.pay.redis.AbstractClient;
import com.toloan.pay.redis.JedisAction;
import com.toloan.pay.redis.ShardedJedisAction;
...
public class RedisServiceImpl  implements RedisService {
    ...
    public Long lpush(final String key, final Object value) {
        return this.execute(new JedisAction<Long>() {
            public Long doAction(Jedis jedis) {
                return jedis.lpush(key.getBytes(), value.toString().getBytes());
            }
        });
    }
